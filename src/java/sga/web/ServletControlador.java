...
public class ServletControlador extends HttpServlet {
    ...
    private void confirmarUsuarioEnSession(HttpServletRequest request, HttpServletResponse response)
        ...
        //Revisamos si ya esta el usuario en la sesion
    ...
    private void editarPersona(HttpServletRequest request, HttpServletResponse response)
        ...
        if (idPersonaParam != null && !idPersonaParam.trim().equals("")) {
            ...
            request.setAttribute("mensaje", mensaje);
            //Reutilizamos el cado de listar personas
            this.listarPersonas(request, response);
        }
    ...
    private void eliminarPersona(HttpServletRequest request, HttpServletResponse response)
        ...
        //4. Redireccionamos al listado de personas (ya no debe mostrar los registros eliminados)
        request.setAttribute("mensaje", mensaje);
        this.listarPersonas(request, response);
